...
defineStrings({
  en: {
    ...
    "error.truncatedEmpty": "The response was cut off at the token limit before any text came out — the usual case with reasoning models, whose thinking eats the budget first. Raise “max_tokens” on the endpoint, or try again.",
  ...
  de: {
    ...
    "error.truncatedEmpty": "Die Antwort ist am Token-Limit abgeschnitten, bevor Text entstand — der Normalfall bei Reasoning-Modellen, deren Denken das Budget zuerst verbraucht. „max_tokens“ am Endpunkt erhöhen oder erneut versuchen.",
