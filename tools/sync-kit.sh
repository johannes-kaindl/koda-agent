...
for m in think-splitter reasoning endpoint endpoint_config endpoint_diagnostics settings i18n num; do
...
cat > src/vendor/kit/VENDOR.json <<JSON
{
  ...
  "version": "$VER",
  "sha": "$SHA",
  "vendored": "think-splitter.ts, reasoning.ts, endpoint.ts, endpoint_config.ts, endpoint_diagnostics.ts, settings.ts, i18n.ts, num.ts",
